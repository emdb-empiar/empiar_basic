 ...
 *
 * Version history:
 * 3.0.4.1, 2014-10-10, Andrii Iudin changed get_path and get_text to use obj.original.name instead of obj.text
 *
 *
...
//			Modified by Andrii Iudin
//			original			
//			p.push(ids ? obj.id : obj.text);
//			new
			p.push(ids ? obj.id : obj.original.name);
...
//			new
			return (!obj || obj.id === $.jstree.root) ? false : obj.original.name;
		},
		/**
