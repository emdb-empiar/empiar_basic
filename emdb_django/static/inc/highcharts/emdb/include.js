...
var chart_menu_items = [ { text: "General"},
			 ...
			 { text: "Trends in direct electron detector usage for released maps", value: "statistics_direct_detector.html"},
			 ...
			 { text: "Trends in released maps with associated atomic models", value: "statistics_atomic_models.html"},
			 { text: "FTP downloads"},
